...
import { Building2, User, Mail, Phone, Lock, ShieldCheck, Warehouse, AlertCircle, CheckCircle2, Eye, EyeOff } from 'lucide-react';
...
export default function GovernmentRegister() {
  ...
  const handleFacilitySelect = (facId) => {
    ...
    // Officer types their own real email — no auto-generation
  };
  ...
  const handleRegister = async (e) => {
    ...
    setSuccessMsg(`✅ Officer account created for ${activeFac?.name || 'Assigned Facility'}! Use your email & password to sign in.`);
    setLoading(false);
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                style={{ width: '100%', padding: '0.7rem 0.7rem 0.7rem 2.6rem', borderRadius: '8px', border: '1.5px solid #334155', background: '#0f172a', color: '#f1f5f9', fontSize: '0.9rem', fontWeight: 600, outline: 'none' }}
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <select
                ...
                style={{ width: '100%', padding: '0.7rem 0.7rem 0.7rem 2.6rem', borderRadius: '8px', border: '1.5px solid #334155', background: '#0f172a', color: '#f1f5f9', fontSize: '0.9rem', fontWeight: 600, outline: 'none', cursor: 'pointer' }}
                required
              >
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                style={{ width: '100%', padding: '0.7rem 2.8rem 0.7rem 2.6rem', borderRadius: '8px', border: '1.5px solid #334155', background: '#0f172a', color: '#f1f5f9', fontSize: '0.9rem', fontWeight: 600, outline: 'none' }}
                onFocus={e => e.target.style.borderColor='#16a34a'}
                onBlur={e => e.target.style.borderColor='#334155'}
                minLength={8}
                required
              />
              <button type="button" onClick={() => setShowPass(v => !v)} style={{ position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)', background: 'transparent', border: 'none', cursor: 'pointer', color: '#475569', display: 'flex', alignItems: 'center' }} tabIndex={-1}>
          ...
          <div>
            ...
            <div style={{ position: 'relative' }}>
              ...
              <input
                ...
                required
              />
              <button type="button" onClick={() => setShowConfirmPass(v => !v)} style={{ position: 'absolute', right: '12px', top: '50%', transform: 'translateY(-50%)', background: 'transparent', border: 'none', cursor: 'pointer', color: '#475569', display: 'flex', alignItems: 'center' }} tabIndex={-1}>
